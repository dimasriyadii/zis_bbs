              ...
              <div class="box">
				...
				<a href="#"><button class="btn btn-success" type="button" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus"></i> Add</button></a>
				  ...
				  <table id="data" class="table table-bordered table-striped table-scalable">
						...
						?>
							<!-- link Previous Page --> 
							<li><a href="infaq.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>
						<?php
							}
						?>

						<?php
						$SqlQuery = mysqli_query($connect, "SELECT * FROM infaq");        
						...
						?>
							<li<?php echo $linkActive; ?>><a href="infaq.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
						<?php
							}
						?>
						...
						?>
							<li><a href="infaq.php?page=<?php echo $linkNext; ?>">Next</a></li>
						<?php
						}
						?>
						</ul>
