              ...
              <div class="box">
				...
				<br></br>
				  <table id="data" class="table table-bordered table-striped table-scalable">
						...
						?>
							<!-- link Previous Page --> 
							<li><a href="penerima.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>
						<?php
							}
						?>

						<?php
						$SqlQuery = mysqli_query($connect, "SELECT * FROM penerima");        
						...
						?>
							<li<?php echo $linkActive; ?>><a href="penerima.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
						<?php
							}
						?>
						...
						?>
							<li><a href="penerima.php?page=<?php echo $linkNext; ?>">Next</a></li>
						<?php
						}
						?>
						</ul>
