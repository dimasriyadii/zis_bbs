          ...
          <div class="row">
              ...
              <div class="box">
				...
				if (isset($_POST['submit'])) {
					...
					if (!empty($date1) && !empty($date2)) {
					 ...
					 $q = mysqli_query($connect, "SELECT * FROM zakat WHERE tanggal BETWEEN '$date1' and '$date2'"); 
					} else {
					 // perintah tampil semua data
					 $q = mysqli_query($connect, "SELECT * FROM zakat"); 
					}
				   } else {
					// perintah tampil semua data
					$q = mysqli_query($connect, "SELECT * FROM zakat");
			...
			?>
				...
				<?php
					...
					$formatb = number_format($total_beras,2,",",".");
				?>
					<tr>
