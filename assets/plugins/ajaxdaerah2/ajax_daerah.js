...
function ajaxkota(id){
  var url="select_daerah2.php?prop="+id+"&sid="+Math.random();
...
function ajaxkec(id){
  var url="select_daerah2.php?kab="+id+"&sid="+Math.random();
...
function ajaxkel(id){
  var url="select_daerah2.php?kec="+id+"&sid="+Math.random();
...
function stateChanged2(){
  ...
  if (ajaxku.readyState==4){
    ...
    if(data.length>=0){
      ...
      document.getElementById("kota2").value = "<option selected>Pilih Kota/Kab2</option>";
    }
    document.getElementById("kab_box").style.display='table-row';
    document.getElementById("kec_box").style.display='none';
    document.getElementById("kel_box").style.display='none';
